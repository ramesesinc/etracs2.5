...
public class MainWindowCustomizer 
{
    ...
    private void customizeImpl(final JFrame frame)
    {
        ...
        frame.addPropertyChangeListener("iconImage", new IconImageListener()); 
    ...
    // <editor-fold defaultstate="collapsed" desc=" IconImageListener (Class) ">
    
    private class IconImageListener implements PropertyChangeListener
    {
        ...
        {
            if (processing || image == null) return;
