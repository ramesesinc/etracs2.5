package com.rameses.gov.etracs.rpt.rysetting;
...
public abstract class RYSettingPageFlowController extends PageFlowController
{
    ...
    void delete(){
        ...
        if( listModelHandler ) {
            listModelHandler.handleRemove(entity);
        }
    }
    ...
    *
    ...
    def getLookupLgu() {
        return InvokerUtil.lookupOpener('rysettinglgu:lookup', [settingtype:getSettingType(), ry:entity.ry, onselect:onselectLgu])
    }
    ...
    *
    ...
    def rangeLevelListHandler = [
        ...
        getColumns : { return [
            ...
            new Column(name:'rate', caption:'Rate (%)*', type:'decimal', editable:true, editableWhen:'#{allowRangeColumnEdit[item]}' ),
        ]},
