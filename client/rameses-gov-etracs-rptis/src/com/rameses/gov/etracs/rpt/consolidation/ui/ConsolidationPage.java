...
public class ConsolidationPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xLookupField10.setExpression("#{appraiser.name}");
        xLookupField10.setHandler("lookupAppraiser");
        xLookupField10.setName("appraiser");
        ...
        xDateField12.setName("appraiser.dtsigned");
        ...
        xLookupField11.setExpression("#{recommender.name}");
        xLookupField11.setHandler("lookupRecommender");
        xLookupField11.setName("recommender");
        ...
        xDateField13.setName("recommender.dtsigned");
        ...
        xLookupField12.setExpression("#{taxmapper.name}");
        xLookupField12.setHandler("lookupTaxmapper");
        xLookupField12.setName("taxmapper");
        ...
        xDateField14.setName("taxmapper.dtsigned");
        ...
        xLookupField13.setExpression("#{approver.name}");
        xLookupField13.setHandler("lookupApprover");
        xLookupField13.setName("approver");
        ...
        xDateField15.setName("approver.dtsigned");
