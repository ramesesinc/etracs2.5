...
public class BldgFloorAdjustmentPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xDataTable1.setColumns(new com.rameses.rcp.common.Column[]{
            new com.rameses.rcp.common.Column(null, "Code*", 50, 0, 0, false, true, true, true, null, new com.rameses.rcp.common.LookupColumnHandler("#{item.additionalitem.code}", "lookupAdditionalItem")),
            new com.rameses.rcp.common.Column("additionalitem.name", "Additional Item", 120, 0, 0, false, true, true, false, null, new com.rameses.rcp.common.TextColumnHandler()),
        ...
        xDataTable2.setColumns(new com.rameses.rcp.common.Column[]{
            ...
            new com.rameses.rcp.common.Column("intvalue", "Integer Value", 100, 0, 0, false, true, true, false, null, new com.rameses.rcp.common.IntegerColumnHandler("#,##0", -1, -1)),
            new com.rameses.rcp.common.Column("decimalvalue", "Decimal Value", 100, 0, 0, false, true, true, false, null, new com.rameses.rcp.common.DecimalColumnHandler("#,##0.00", -1.0, -1.0, false))
        });
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                .add(xDataTable1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
