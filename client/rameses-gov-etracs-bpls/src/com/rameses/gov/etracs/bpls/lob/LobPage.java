 ...
 * LobPage.java
 *
 * Created on May 2, 2013, 14:05 PM
 */
...
public class LobPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xLookupField1.setExpression("#{entity.classification.name}");
        ...
        jLabel1.setText("Add LOB Attribute :  ");
        jPanel6.add(jLabel1, java.awt.BorderLayout.WEST);

        xLookupField2.setHandler("lookupAttribute");
        xLookupField2.setHint("Search Attribute");
        xLookupField2.setName("searchAttribute");
        jPanel6.add(xLookupField2, java.awt.BorderLayout.CENTER);

        jPanel5.add(jPanel6, java.awt.BorderLayout.NORTH);

        xDataTable2.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5));
        xDataTable2.setDepends(new String[] {"searchAttribute"});
